Vagrant::Config.run do |config|
  ...
  config.vm.define :chef_server do |chef_server_config|
    ...
    chef_server_config.vm.box_url = "http://www.zeddworks.com:8000/vagrant-oel56-amd64-rvm-07-08-2011-6586c1.box"
  ...
  config.vm.define :chef_client do |chef_client_config|
    ...
    chef_client_config.vm.box_url = "http://www.zeddworks.com:8000/vagrant-oel56-amd64-rvm-07-08-2011-6586c1.box"
